...
$Context = New-AzStorageContext -StorageAccountName $staname -StorageAccountKey $stakey -Protocol Https

$Blob1HT = @{
  File             = $SPReportHTMLFilePath
  Container        = $ContainerName
  Blob             = 'ServicePrincipalReport.html'
  Context          = $Context
